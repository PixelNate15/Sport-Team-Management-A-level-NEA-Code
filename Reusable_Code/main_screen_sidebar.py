...
class main_screen_sidebar(tk.Frame):
    def __init__(self, parent, buttons):
        super().__init__(parent, bg=c.LIGHT_SIDEBAR, width=225)
        ...
        for text, command in buttons:
            btn = Rounded_Button(self.btn_frame, text=text, command=command, font=c.FONT_BUTTON, bg_colour=c.LIGHT_PRIMARY_ACCENT, hover_colour=c.LIGHT_ACCENT_HOVER, fg_colour="white", width=200, height=42, radius=16, parent_bg=c.LIGHT_SIDEBAR)
            btn.pack(pady=15)