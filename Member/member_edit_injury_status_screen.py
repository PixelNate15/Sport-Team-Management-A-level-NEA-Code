...
class Member_Edit_Injury_Status(tk.Frame):
    def __init__(self, parent, app, user_id, injury):
        ...
        self.ent_injury.insert(0, self.injury["description"])
        ...
        self.ent_expected_return_date.set_date(self.injury["expected_end_date"])
        ...
        self.can_play = IntVar(value=self.injury["can_play"])
        ...
        self.txt_notes.pack()
        self.txt_notes.insert("1.0", self.injury["notes"])
